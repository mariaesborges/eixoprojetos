const projetos = [
  // id=0
  {
    ...
    sidebar:[['Área Total','42 hectares'],['Lotes','348 unidades'],['Prazo','18 meses'],['Status','Concluído'],['Norma','NBR 6118']],
    site:'https://residencialserraverde.com.br/',
  },
  // id=1
  {
  ...
  // id=2
  {
    ...
    sidebar:[['Localização','R. Avelino Soares de Faria, 28 — Bela Vista'],['Terreno','6 × 25,90 m'],['Área Construída','137,55 m²'],['Configuração','3 quartos (1 suíte com closet)'],['Diferenciais','Pé-direito duplo e área gourmet integrada'],['Prazo','10 meses'],['Status','Vendida']],
  },
  // id=3
  {
    ...
    sidebar:[['Terreno','6 × 26 m'],['Área Construída','45,53 m² + varanda'],['Configuração','2 quartos e 1 banheiro social'],['Garagem','2 vagas descobertas'],['Diferenciais','Espaço para ampliação e horta residencial'],['Status','Disponível para venda']],
  },
  // id=4
  {
    title:'Obra Maria Rodart – Casa 04', cat:'Residencial', loc:'São Roque de Minas, MG', year:'2025',
    imgs:["img/rodart4_01.jpg", "img/rodart4_02.jpg", "img/rodart4_03.jpg", "img/rodart4_04.jpg", "img/rodart4_05.jpg", "img/rodart4_06.jpg", "img/rodart4_07.jpg", "img/rodart4_08.jpg", "img/rodart4_09.jpg", "img/rodart4_10.jpg"],
    ...
    sidebar:[['Terreno','6 × 27 m'],['Área Construída','73 m²'],['Configuração','2 quartos e 1 banheiro social'],['Ambientes','Sala e cozinha integradas'],['Diferenciais','Área gourmet e possibilidade de ampliação'],['Status','Vendida']],
  },
  // id=5
  {
    title:'Obra Arizona', cat:'Residencial', loc:'São Roque de Minas, MG', year:'2024',
    imgs:["img/arizona_01.jpg", "img/arizona_02.jpg", "img/arizona_03.jpg", "img/arizona_04.jpg", "img/arizona_05.jpg", "img/arizona_06.jpg", "img/arizona_07.jpg"],
    ...
    sidebar:[['Área Construída','113,40 m²'],['Configuração','2 quartos e 1 banheiro social'],['Diferenciais','Pé-direito duplo e acabamento premium'],['Garagem','2 vagas'],['Acabamentos','Piso retificado polido e tintas emborrachadas'],['Itens Inclusos','Portão eletrônico, cooktop e acessórios dos banheiros'],['Status','Vendida']],
  },

  // id=6
  {
    title:'Loteamento Jardim Alvorada', cat:'Loteamento', loc:'São Roque de Minas, MG', year:'2025',
    imgs:["img/alvorada_01.jpg","img/alvorada_02.jpg","img/alvorada_03.jpg","img/alvorada_04.jpg","img/alvorada_05.jpg","img/alvorada_06.jpg"],
    desc:'O Jardim Alvorada é um loteamento planejado que une localização estratégica, infraestrutura completa e contato com a natureza. Situado em uma das principais avenidas da cidade, o empreendimento foi concebido para oferecer praticidade, valorização imobiliária e qualidade de vida aos futuros moradores. Com 155 lotes a partir de 250 m², o projeto se destaca pela vista privilegiada para a Serra da Canastra, proximidade com a futura unidade do Hospital Municipal Santa Marta e uma infraestrutura urbana planejada para acompanhar o crescimento da região.',
    delivs:['Projeto urbanístico completo','Rede de abastecimento de água','Sistema de saneamento e esgotamento sanitário','Rede de drenagem pluvial','Pavimentação asfáltica','Rede de energia elétrica','Iluminação pública','Áreas institucionais planejadas','Área destinada ao futuro Hospital Municipal Santa Marta','Lotes residenciais a partir de 250 m²'],
    sidebar:[['Área Total','12 hectares'],['Lotes','155 unidades'],['Tamanho dos Lotes','A partir de 250 m²'],['Status','Em implantação']],
    site:'https://www.jardimalvorada.com',
  },
